...
function App() {
  ...
  const getFollowingPosts = async () => {
    ...
    const response = await fetch('http://localhost:8000/posts/feed/following', requestOptions);
        ...
        <div class="   dark:text-white rounded-lg  md:ml-[560px] ">
          ...
          <div >
                ...
                <div class="font-bold flex w-full  text-xl mb-2">
                  <div className='flex w-full bg-light_main'>
                    ...
                    <div className='ml-2 w-full dark:bg-gray-600 rounded-lg hover:dark:bg-gray-400 transition duration-300 cursor-pointer'>
                      <div onClick={onOpen}> <span className='dark:text-gray-400' >  {`What's on your mind, ${username}?`} </span>
                        <div className=''>
            ...
            <Tabs isFitted className='w-full '>
              <TabList >
                <Tab className='w-full' >For You</Tab>
                <Tab  className='w-full'  >Following</Tab>
              </TabList>
              <TabIndicator
                mt="-1.5px"
                height="2px"
